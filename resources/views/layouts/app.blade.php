            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="{{url('/')}}" class="logo">
                        <img src="{{asset('assets/imgs/logo.png')}}" style="width: 60px; height: auto;">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        @if (Request::is('calories-calculate'))
                            {{-- TAMPILAN NAVBAR UNTUK HALAMAN CALORIES --}}
                            @auth
                            ...
                            @endauth
                        @elseif (!in_array(Request::path(), ['login', 'register', 'password/reset']))
                            {{-- NAVBAR UNTUK HALAMAN BIASA --}}
